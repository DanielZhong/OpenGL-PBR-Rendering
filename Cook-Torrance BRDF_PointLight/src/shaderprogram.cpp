...
void ShaderProgram::create(const char *vertfile, const char *fragfile)
{
    ...
    unifRustToggle = context->glGetUniformLocation(prog, "u_RustToggle");
}
...
void ShaderProgram::setRustToggle(bool enabled) {
    useMe();
    if (unifRustToggle != -1) {
        context->glUniform1i(unifRustToggle, enabled ? 1 : 0);
    }
}
