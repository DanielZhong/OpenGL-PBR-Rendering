...
void Scene::CreateTestScene()
{
    ...
    auto matteFloor = Material(Color3f(0.71, 0.141, 0.839), 0, -1, DIFFUSE_REFL, nullptr, nullptr, nullptr);
    ...
    auto matteWhiteTrans   = Material(Color3f(0.725, 0.71, 0.68), 0, -1, DIFFUSE_TRANS, nullptr, nullptr, nullptr);

    // Floor, which is a large white plane
    uPtr<RectangleShape> floor = mkU<RectangleShape>(glm::vec3(0, -2.5, 0), glm::vec3(0, 1, 0), glm::vec2(5,5), matteFloor);
    ...
    // Short cube
    uPtr<Box> shortCube = mkU<Box>(glm::vec3(-3.5, -2.5, -0.75), glm::vec3(-0.5, 0.5, 2.25), matteWhiteTrans);
